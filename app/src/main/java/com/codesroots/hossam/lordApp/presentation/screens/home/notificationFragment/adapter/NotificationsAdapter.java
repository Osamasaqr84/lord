package com.codesroots.hossam.lordApp.presentation.screens.home.notificationFragment.adapter;
...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final NotificationsAdapter.ViewHolder holder, final int position) {
      ...
      //  holder.person_img.setImageResource(R.drawable.barashot_logo);
        holder.name.setText(allnotification.get(position).getText());
        holder.time.setText(getdate(allnotification.get(position).getCreated()));
    }
